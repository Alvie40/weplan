...
const WebsiteContent = () => (
  <div>
    ...
    <TopicContainer id="wedding" title="Wedding">
      <div className="container">
        <div className="one-half column">
          ...
          <p>
            Located to the left of the Loggia and Clock Tower (the Town Hall)
            and behind the market and row of shops at the back of the harbour.
            Follow signs to the Hotel Park and continue past the café until you
            arrive at the Church. Also have a look at the tourist map above.
          </p>
        </div>
        <div className="one-half column">
          <h2>RECEPTION</h2>
          ...
          <p>
            Located a 10 minute walk from Sveti Marak and there will be someone
            to lead the way. Ladies, please bear in mind that the walk is over a
            cobbled path, which would not be comfortable if wearing heels, so
            you might consider bringing a pair of flats for the trek.
          </p>
        </div>
      </div>
      ...
      <p>
        ...
        with which you will be comfortable with the heat. And ladies, you look
        pretty as you are, in your formal summer dresses :)
      </p>
    ...
    <TopicContainer id="gifts" title="Gifts">
      ...
      <p>
        We feel honoured that you are all travelling a long way to come and
        celebrate our special day with us. For this reason we don't want anyone
        to feel obliged to buy us gifts. Your presence is the biggest gift.
      </p>
      <p>
        If you do feel that you want to give us a gift please remember that just
